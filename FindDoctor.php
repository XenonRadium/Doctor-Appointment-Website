...
<body>
  ...
  <div class="container-fluid">
    <div class="row" >
      ...
      <div class="col-lg-9" style="margin: 10px 0 0 20px;">
        <h1 class="text-center" id="textChange">All Doctors</h1>
        ...
        <div class="row" id="result">
          ...
          <div class="col-md-3 mb-2">
            <div class="card-deck" style="margin: 0 0 20px 0;">
              <div class="card border-secondary" style="">
                <img src="<?= $row['doctor_image']; ?>" class="card-img-top">
                <div class="card-body">
                  <h4 style="height:60px;"><?= $row['doctor_name']; ?></h4>
                  <h6><?= $row['expertise']; ?></h6>
                  <a href="TestDoctorPage.php?doctorname=<?= $row['doctor_name']; ?>" class="btn btn-primary btn-sm mt-auto d-flex flex-column">Profile</a>
